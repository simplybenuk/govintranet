<?php
	...
	************************************************/
	...
	if ( version_compare( $database_version, "4.19", '<' ) ):
		...
		$wpdb->query("delete from $wpdb->postmeta where meta_key='_pods_casestudy';");
		$wpdb->query("delete from $wpdb->postmeta where meta_key='_pods_casestudy_vacancies';");
		...
		$wpdb->query("delete from $wpdb->postmeta where meta_key='_pods_related_casestudies';");
	...
	if ( version_compare( $database_version, "4.34", '<' ) && $update_okay ):
		...
		// Remove old casestudy metadata
		$wpdb->query("delete from $wpdb->postmeta where meta_key='casestudy_policy_link';");
		$wpdb->query("delete from $wpdb->postmeta where meta_key='_casestudy_policy_link';");
		$wpdb->query("delete from $wpdb->postmeta where meta_key='casestudy_start_time';");
		$wpdb->query("delete from $wpdb->postmeta where meta_key='_casestudy_start_time';");
		$wpdb->query("delete from $wpdb->postmeta where meta_key='casestudy_end_time';");
		$wpdb->query("delete from $wpdb->postmeta where meta_key='_casestudy_end_time';");
		$wpdb->query("delete from $wpdb->postmeta where meta_key='casestudy_chapter_number';");
		$wpdb->query("delete from $wpdb->postmeta where meta_key='_casestudy_chapter_number';");
